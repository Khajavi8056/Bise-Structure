...
// تعریف ثابت‌های مورد نیاز برای سازگاری با تمام نسخه‌های MT5 - برای جلوگیری از خطاهای constant expected
const int CORNER_RIGHT_UPPER = 3;  // مقدار عددی برای گوشه بالا راست (جایگزین CORNER_RIGHT_UPPER)
...
void StructureAnalyzer::DrawTrendText()
  {
   ...
   ObjectSetInteger(0, name, OBJPROP_CORNER, CORNER_RIGHT_UPPER); // تنظیم مکان به گوشه بالا راست با ثابت تعریف‌شده

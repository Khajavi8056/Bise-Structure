...
//| 1. اصلاح شرط ArrayInsert برای رفع خطای "Veritable expected".      |
...
void AddFVG(bool isBullish, double highPrice, double lowPrice, datetime time) 
{
   ...
   // ✨ اصلاح: استفاده از ArrayInsert و چک کردن مقدار برگشتی به صورت مستقیم برای رفع خطای "Veritable expected"
   // 0: موفقیت، -1: شکست
